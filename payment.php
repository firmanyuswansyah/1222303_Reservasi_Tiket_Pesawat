          ...
          <h1 class="text-center text-light">PAY INVOICE</h1>
            ...
            <form action="includes/payment.inc.php" method="post" 
                ...
                <div class="form-group">
                    ...
                    <span class="invalid-feedback">Masukkan 16 Digit Nomor Kartu Yang Valid</span>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <span class="invalid-feedback">Masukkan Tanggal Kadaluarsa</span>
                        </div>
                    </div>
                    <div class="col-6 p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col pr-0">                            
                                <span class="invalid-feedback order-last">Masukka 3-digit code dibelakang</span>
