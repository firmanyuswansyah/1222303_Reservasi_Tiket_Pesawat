                            ...
                            <div class="row">
                                    ...
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            ...
                                            <div class="intro_subtitle">
                                                <p>Apa yang ingin anda tambahkan pada bucket perjalanan anda?</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 intro_col">
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            <div class="intro_title">Harga Terbaik</div>
                                            <div class="intro_subtitle"><!-- log on to codeastro.com for more projects -->
                                                <p>Kunjungi tempat favorit anda dengan harga yang terjangkau!</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 intro_col">
                                    <div class="intro_item d-flex flex-row align-items-end justify-content-start">
                                        ...
                                        <div class="intro_content">
                                            <div class="intro_title">Pelayanan Terbaik</div>
                                            <div class="intro_subtitle">
                                                <p>Interaksi yang baik dimulai dari mengetahui apa yang dibutuhkan dan diinginkan oleh kustomer.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<em><h5 class="text-light text-center p-0 brand mt-2">
			...
			Pemesanan tiket Penerbangan Online</h5></em>
	<div class="text-light text-center">&copy; <?php echo date('Y')?> - Developed By Ayu, Akbar dan Firman<br><br></div>
	<!-- <p>----------</p> -->
