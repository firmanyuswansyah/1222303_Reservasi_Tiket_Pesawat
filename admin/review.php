...
<div class="container mt-4 mb-4">
  <h1 class="text-center mb-4 text-light">REVIEW DARI CUSTOMER</h1>
  <div class="row">
    <?php
    ...
    while ($row = mysqli_fetch_assoc($result)) { 
      ...
      <div class="review-bag">  
        ...
        <p class="quest">'Apa Kesan Pertamamu Pada Website Kami?'</p>
        <p class="ans">'.$row['q1'].'</p>
        <p class="quest">'Bagaimana Kamu Tahu Tentang Website Kami?'</p>
        <p class="ans">'.$row['q2'].'</p>
        <p class="quest">'Apakah Ada Kesalahan Pada Website Kami?'</p>
