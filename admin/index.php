...
.dashbord-red .detail-section{
      ...
      <div class="card-body">
          <div class="dropdown" style="float: right;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <a class="dropdown-item" href="#dep">Area Keberangkatan Penerbangan Hari Ini</a>
              <a class="dropdown-item" href="#arr">Tempat Tiba Penerbangan Hari Ini</a>
            </div>
          </div>        
    ...
    <div class="card" id="dep">
      <div class="card-body">
        ...
        <p class=" text-secondary">Area Keberangkatan Penerbangan Hari Ini</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr><!-- log on to codeastro.com for more projects -->
              <th scope="col">#</th>
    ...
    <div class="card mb-4" id="arr">
      <div class="card-body">
        ...
        <p class=" text-secondary">Tempat Tiba Penerbangan Hari Ini</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr><!-- log on to codeastro.com for more projects -->
              <th scope="col">#</th>
