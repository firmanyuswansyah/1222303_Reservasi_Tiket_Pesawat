      ...
      <div class="row justify-content-center">  
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">Apa kesan pertamamu saat melihat website ini?</label>     
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              ...
              width:100%" required>
                <option  selected disabled>Bagaimana kamu mengetahui tentang kami?</option>
                <option >Pencarian Google</option>
                <option >Social Media</option>
                <option >Relasi dari teman</option>
          ...
          <div class="col-12 mt-4">
            <div class="form-group">         
              <label for="exampleFormControlTextarea1">Apa ada kesalahan dari halaman ini?</label>     
...
<footer>
	...
	<p class="text-light text-center">&copy; <?php echo date('Y');?> - Developed By Ayu, Akbar dan Firman.</p>
</footer>